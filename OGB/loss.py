...
# Yes, if you implement a loss function outside of nn.Module but use PyTorch operations to calculate it, 
# it will still be part of the computational graph. As long as your operations on tensors support autograd (automatic differentiation), 
# PyTorch will track all the operations on tensors that require gradients, regardless of whether the code is within an nn.Module subclass or a standalone function.
