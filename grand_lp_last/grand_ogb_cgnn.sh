...
python allin_grand_ncnc.py --xdp 0.25 --tdp 0.05 --pt 0.1 --gnnedp 0.25 --preedp 0.0 --predp 0.3 --gnndp 0.1 \
 --probscale 2.5 --proboffset 6.0 --alpha 1.05  --gnnlr 0.1 --prelr 0.1  --batch_size 32768 \
 --ln --lnnn --predictor cn1 --data_name ogbl-collab  --epochs 30 --hidden_dim 64 --num_layers 3 --mplayers 1  \
 --testbs 131072  --device 0 --maskinput --res  --use_xlin  --tailact 

# python allin_grand_ori.py --data_name ogbl-collab --device 0 --epoch 30 --hidden_dim 64 --batch_size 32768 --no_early
